...
<html>
<head>
	<title>Bake List 2</title>
	<meta charset="utf-8" >
  	<meta name="viewport" content="width=device-width,  initial-scale=1">
	<link href='https://fonts.googleapis.com/css?family=Cabin+Condensed:700' rel='stylesheet' type='text/css'>
	<style>
		html,body{
			background-image: url(http://getwallpapers.com/wallpaper/full/7/f/2/1152246-download-free-chocolate-chip-cookie-wallpaper-1920x1280-for-full-hd.jpg);
...
<body>
	 <div align="center">
 		<div id="header">
    		<a href="#" id="logo">Bake</a>
		
		</div>
		<div style="margin-left: 250px">
			<div style="clear: left;">
				<br>
				<p style="float: left;"><img src="img/flakes.jpeg" height="250px" width="300px" border="2px"></p>
				<br><br><br>
				<div id="div2" align="left">
					
						<?php
							$sql = "SELECT * from product where PId = 'B12'";
			...
			<div style="clear: left;">
				<br>
				<p style="float: left;"><img src="img/biskut pelangi.jpg" height="250px" width="300px" border="2px"></p>
				<br><br><br>
				<div id="div2" align="left">
					
						<?php
							$sql = "SELECT * from product where PId = 'B13'";
							$result = mysqli_query($data, $sql);
							while ($row = mysqli_fetch_array($result)) {
								echo "<table>";
								echo "<tr><td><b>Product ID <td>:</td></b></td><td> " .$row['PId']."</td></tr>";
		...
		<br><br><br>
 		<div id="header">
  			<ul id="menu">
  				<li><a href="bakeList.php"  onmouseover="PlaySound('back')" 
    ...
    onmouseout="StopSound('home')"><span>Home</span></a></li>
    			<li><a href="bakeList3.php"  onmouseover="PlaySound('next')" 
