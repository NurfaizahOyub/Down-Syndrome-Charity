...
<body>
  <div align="center">
    <div id="header">
        <a href="#" id="logo">Search Product Name</a>
    </div>
  </div>
  <br><br>
  ...
  <form id="form1" name="form1" method="POST" action="listCustSearch.php">
  <p align="center" >
    <br><br>
    <label for="ProdName"><b>Enter Product Name : </b></label>
    <select name="ProdName">
        ...
        <option value="Laptop Bag">Laptop's Bag</option>
        <option value="Pencil Box">Pencil Box</option>
        <option value="Arrangement Box">Arrangement Box</option>
      </select>
  </p>
  <p align="center">
    <input class="btn float-center login_btn" type="submit" name="btnsubmit" id="btnsubmit" value="Submit" onmouseover="PlaySound('submit')" 
    onmouseout="StopSound('submit')"/>
    <input class="btn float-center login_btn" type="reset" name="btnreset" id="btnreset" value="Reset"  onmouseover="PlaySound('reset')" 
    onmouseout="StopSound('reset')"/>
  </p>
  <p>&nbsp;</p>
</form>
</div>  
...
<div id="header" align="center">
    ...
    <audio id='home' src="Sound/Home.mp3"/>   
      <audio id='submit' src="Sound/Submit.mp3"/> 
      <audio id='reset' src="Sound/Reset.mp3"/>
