...
<div Align="Center"><input class="btn float-center login_btn" type="submit" name="btnsubmit" id="btnsubmit" value="Order Now" onclick="window.location.href = 'feltForm.php'"></div><br><br>
