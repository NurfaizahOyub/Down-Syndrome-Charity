...
<body>
	 <div align="center">
		...
		<div style="margin-left: 250px">
			<div>
				<br>
				<p style="float: left;"><img src="img/laptopBag3.jpg" height="250px" width="300px" border="2px"></p>
				<br><br><br>
				<div id="div2" align="left">
					
						<?php
							$sql = "SELECT * from product where PId = 'C18'";
			...
			<div style="clear: left;">
				<br>
				<p style="float: left;"><img src="img/pecilBox2.jpg" height="250px" width="300px" border="2px"></p>
				<br><br><br>
				<div id="div2" align="left">
					
						<?php
							$sql2 = "SELECT * from product where PId = 'C19'";
		...
		<br><br><br>
 		<div id="header">
  			<ul id="menu">
          <li><a href="craftList.php" onmouseover="PlaySound('back')" 
    ...
    onmouseout="StopSound('home')"><span>Home</span></a></li>
    			<li><a href="craftList3.php" onmouseover="PlaySound('next')" 
