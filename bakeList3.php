	 ...
	 <div align="center">
		...
		<div style="margin-left: 250px">
			<div style="clear: left;">
				<br>
				<p style="float: left;"><img src="img/tart nenas.jpg" height="250px" width="300px" border="2px"></p>
				<br><br><br>
				<div id="div2" align="left">
					
						<?php
							$sql = "SELECT * from product where PId = 'B14'";
		...
		<br><br><br>
 		<div id="header">
  			<ul id="menu">
  				<li><a href="bakeList2.php" onmouseover="PlaySound('back')" 
