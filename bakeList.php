...
<body>
	 <div align="center">
		...
		<div style="margin-left: 250px">
			<div>
				<br>
				<p style="float: left;"><img src="img/COOKIES3.jpg" height="250px" width="300px" border="2px"></p>
				<br><br><br>
				<div id="div2">
					
						<?php
							$sql = "SELECT * from product where PId = 'B10'";
			...
			<div style="clear: left;">
				<br>
				<p style="float: left;"><img src="img/dahlia.jpg" height="250px" width="300px" border="2px"></p>
				<br><br><br>
				<div id="div2" align="left">
					
						<?php
							$sql2 = "SELECT * from product where PId = 'B11'";
    ...
    onmouseout="StopSound('home')"><span>Home</span></a></li>
          <li><a href="bakeList2.php" onmouseover="PlaySound('next')" 
